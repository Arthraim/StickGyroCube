...
point2 Camera::project(const point3 &point, bool clip /* = true */, bool shouldRound /* = true */) const
{
    point2 ret;
...
line2 Camera::project(const line3 &line, bool clip /* = true */, bool shouldRound /* = true */) const
{
    line2 ret;
